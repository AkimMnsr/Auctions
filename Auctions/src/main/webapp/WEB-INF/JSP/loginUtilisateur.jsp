...
<body>
	...
	<div id="formuDiv">
		<form id="formulaire" method="post" action="/Auctions/WelcomePageUser">
			<div class="rowmb-3">
				<label for="inputEmail3" class="col-sm-2 col-form-label">Identifiant</label>
				<div class="col-sm-10">
				...
				<div>
					<div class="col-sm-10 offset-sm-2">
						<div class="form-check">
							<input class="form-check-input" type="checkbox" id="gridCheck1">Se
